	...
	<div class="form">
		...
		<div class="tab-content">
			...
			<div id="generate">
				...
				<form action="FrysProductTypeServlet" method="post">
					<input type="hidden" id="productOperation" name="productOperation" value="generate_product_type">
					<div class="top-row">
			...
			<div id="delete">
				<form action="FrysProductTypeServlet" method="post">
					<input type="hidden" id="productOperation" name="productOperation" value="delete_product_type">
					<div class="top-row">
						<div class="field-wrap">
