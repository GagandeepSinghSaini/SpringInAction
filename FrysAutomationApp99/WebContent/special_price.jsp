    ...
    <div class="form">
      ...
      <div class="tab-content">
        ...
        <div id="generate">   
          ...
          <form action="SpecPriceServlet" method="post">
         <input type="hidden" id=spriceOperation" name="spriceOperation" value="sprice_generate">
              ...
              <div class="field-wrap">
                <input type='text'  name="endDate" id='datetimepicker2' required placeholder="END DATE" title="END DATE OF SPECIAL PRICE"/>
              </div>
        ...
        <div id="delete">   
          <form action="SpecPriceServlet" method="post">
          <input type="hidden" id="spriceOperation" name="spriceOperation" value="delete_sprice">
            <div class="field-wrap">
            <label >
